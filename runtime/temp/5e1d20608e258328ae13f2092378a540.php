...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <table class="table">
            ...
            <tr>
                <td class="center"><?php echo htmlentities($list['order_id']); ?></td>
                <td><?php echo htmlentities($list['name']); ?></td>
                <td><?php echo htmlentities($list['phone']); ?></td>
                <td>
                    <address><?php echo htmlentities($list['address']); ?></address>
                </td>
                <td class="center"><strong class="rmb_icon"><?php echo htmlentities($list['cost']); ?></strong></td>
                <td class="center">顺丰快递</td>
                <td class="center">
                    <a href="/admin/admin/order_detail?id=<?php echo htmlentities($list['order_id']); ?>" title="查看订单" class="link_icon" target="_blank">&#118;</a>
                    <a href="" title="删除" class="link_icon">&#100;</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </table>
        <div id="divcss5"><?php echo $order_list; ?></div>
    </div>
</section>
