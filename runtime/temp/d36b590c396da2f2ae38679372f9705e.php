...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <table class="table">
            ...
            <?php if(is_array($down_user) || $down_user instanceof \think\Collection || $down_user instanceof \think\Paginator): $i = 0; $__LIST__ = $down_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td class="center">
                    <a href="javascript:uups(<?php echo htmlentities($list['id']); ?>)" title="启用用户" class="link_icon">&#100;</a>
                </td>
                <script type="text/javascript">
                    function uups(id) {
                        var date={"id":id};
                        url='/admin/admin/uups';
        ...
        <div id="divcss5"><?php echo $down_user; ?></div>
    </div>
</section>
