                        ...
                        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                            ...
                            <div class="order-main">
                                <div class="order-list">
                                    ...
                                    <!--交易成功-->
                                    <?php if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                                ...
                                                <ul class="item-list">
                                                        ...
                                                        <div class="item-info">
                                                            <div class="item-basic-info">
                                                                <a href="#">
                                                                    ...
                                                                    <p class="info-little">优惠卷：暂无可用优惠卷
                                                                        <br/>红包：暂无可用红包 </p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li class="td td-price">
                                                        <div class="item-price">
                                                            <?php echo htmlentities($list['cost']); ?>
                                                        </div>
                                                    </li>
                                                    <li class="td td-number">
                                                        <div class="item-number">
                                                            <span>×</span><?php echo htmlentities($list['num']); ?>
                                                        </div>
                                                    </li>
                                            ...
                                            <div class="order-right">
                                                <li class="td td-amount">
                                                    <div class="item-amount">
                                                        合计：<?php echo htmlentities($list['cost']*$list['num']); ?>
                                                        <p>全国<span>包邮</span></p>
                                                    </div>
                                                </li>
                                                <div class="move-right">
                                                    ...
                                                    <li class="td td-change">
                                                        <div class="am-btn am-btn-danger anniu">
                                                            <a href="/index/shopcart/dorder?order_id=<?php echo htmlentities($list['order_id']); ?>&product_id=<?php echo htmlentities($list['product_id']); ?>">无理由退货</a></div>
                                                    </li>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="divcss5s" ><?php echo $order; ?></div>
