...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <table class="table">
            ...
            <?php if(is_array($admin) || $admin instanceof \think\Collection || $admin instanceof \think\Paginator): $i = 0; $__LIST__ = $admin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr>
                ...
                <td class="center">
                    ...
                    <a href="javascript:down(<?php echo htmlentities($list['product_id']); ?>)" title="下架" class="link_icon">&#100;</a>
                </td>
                <script type="text/javascript">
                    function down(id) {
                        var date={"product_id":id};
                        url='/admin/admin/down';
        ...
        <div id="divcss5"><?php echo $admin; ?></div>
    </div>
</section>
